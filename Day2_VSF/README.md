...
Chào mừng đến với bộ hồ sơ hoàn chỉnh cho **Bài tập Thực tập Day 2: Ứng dụng SDLC Harness cho AI Coding Assistant (Claude Code / Antigravity IDE)**.
...
└── README.md                                  # Tài liệu tổng hợp & hướng dẫn nộp bài
```
...
- Xem chi tiết tại file: [`Bao_Cao_Hien_Trang_Lam_Viec_Voi_AI.md`](file:///c:/Users/Admin/OneDrive/Máy%20tính/Minh/VSF/Day2_VSF/Bao_Cao_Hien_Trang_Lam_Viec_Voi_AI.md)
...
- **Báo cáo Insight trải nghiệm:** Xem chi tiết tại file [`Bao_Cao_Insight_SDLC_Harness.md`](file:///c:/Users/Admin/OneDrive/Máy%20tính/Minh/VSF/Day2_VSF/Bao_Cao_Insight_SDLC_Harness.md).
...
Double click vào file [`index.html`](file:///c:/Users/Admin/OneDrive/Máy%20tính/Minh/VSF/Day2_VSF/index.html) hoặc kéo thả file `index.html` vào trình duyệt Web (Chrome, Edge, Firefox).
