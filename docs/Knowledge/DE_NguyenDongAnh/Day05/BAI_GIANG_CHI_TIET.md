...
$$\text{Leakage Rate} = \frac{\text{Số câu truy vấn rò rỉ dữ liệu tenant khác}}{\text{Tổng số câu kiểm thử (100 cases)}} = 0.0\%$$
...
$$\text{cost\_usd} = \left(\frac{\text{prompt\_tokens}}{1000} \times 0.005\right) + \left(\frac{\text{completion\_tokens}}{1000} \times 0.015\right)$$
